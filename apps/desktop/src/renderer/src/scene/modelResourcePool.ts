...
import type { PreparedGeometryBounds, PreparedTextureIdentity } from './mapGeometryPrepare.js';
...
export class ModelResourcePool {
  ...
  public getOrCreateGeometry(
    ...
    const resourceKey = preparedHints?.cacheKey ? `${key}:${preparedHints.cacheKey}` : key;
