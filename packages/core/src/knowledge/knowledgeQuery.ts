...
export function queryKnowledgeClaims(store: KnowledgeStore, query: string, options: KnowledgeQueryOptions): KnowledgeClaim[] {
...
export function readKnowledgePage(store: KnowledgeStore, pageId: string, options: KnowledgeQueryOptions): KnowledgePage | undefined {
