...
const REL_G_SUBJECT_SET = Object.freeze({
  files: Object.freeze([
    ...
    'packages/core/src/model-services/fileRolloutStorage.ts',
    'packages/core/src/model-services/index.ts',
    'packages/core/src/testing/harness/scaffoldToolRegistry.ts',
    'packages/core/src/testing/harness/scaffoldPolicyGate.ts',
