...
|---|---|---|---|---|---|
| `W-EMEVD-FULL-01` | `claim-w-emevd-full-01-20260802` | 3516027002att-ui | 2026-08-02T17:04:37.516Z | 2026-08-02T17:04:37.516Z | 检查该切片 `entryPoints` 对应工作树改动与运行中的写进程；无相关写进程则保存后审查再原子回退 ready |
