...
| `W-REL-COMPLIANCE-02` | `active` | `partial` | — | `REL-COMPLIANCE` | 继续 NSIS installer lifecycle 验证（安装/升级/卸载/干净目标）、package tree 内容扫描和 manifest/hash 完整性 | `W-REL-COMPLIANCE-01` 已完成许可证文本和 NSIS 构建；不要求代码签名 | `apps/desktop/electron-builder.json`、`scripts/release-compliance-lib.mjs` | `npm run test:release-compliance-fixtures`、`npm run test:release-content` | cap=`partial`；不声明外部分发或签名发布通过 |
...
|---|---|---|---|---|---|
| `W-EMEVD-FULL-01` | `claim-emedf-matrix-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 emevd 工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-EMEVD-FMG-PARAM-03` | `claim-param-fmg-harden-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 param/fmg 工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-REL-F-SCALE-02` | `claim-scale-fleet-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 editor 契约/前端工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-AI-CONFORMANCE-03` | `claim-ai-context-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 model-services 工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-A-RECOVERY-INTEGRATION-04` | `claim-recovery-fleet-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 transactions/patch 工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-REL-B-CORPUS-02` | `claim-krak-fleet-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 corpus/writer 工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-REL-COMPLIANCE-02` | `claim-installer-fleet-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 release/compliance 工作树改动；无相关写进程则保存后审查再原子回退 ready |
| `W-BEHAVIOR-MAP-01` | `claim-behavior-fleet-20260801` | coordinator-agent | 2026-08-01 | 2026-08-01 | 检查任务进程状态与 script/probe 工作树改动；无相关写进程则保存后审查再原子回退 ready |
