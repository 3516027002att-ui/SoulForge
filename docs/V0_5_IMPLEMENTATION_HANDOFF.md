...
```json
{
  ...
  "scopeItems": [
    ...
    },
    {
      ...
      "capabilityId": "MATERIAL-53",
      "gateIds": [
        "REL-SCOPE"
      ],
      "subjectKind": "material-format",
