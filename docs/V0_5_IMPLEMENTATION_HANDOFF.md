...
|---|---|---|---|---|---|
| `W-REL-C-PARAM-04` | `claim-w-rel-c-param-04-20260803` | me | 2026-08-03T20:13:32.989Z | 2026-08-03T20:13:32.989Z | 检查该切片 `entryPoints` 对应工作树改动与运行中的写进程；无相关写进程则保存后审查再原子回退 ready |
...
- `W-REL-C-MULTILANG-02`：全官方语言 FMG 写验证（本机仅 zhocn 展开，其余官方语言在原版 .bdt 归档内，需真实多语言语料）；
...
| `REL-C` | 核心语义 mutation 矩阵 | `W-REL-C-MULTILANG-02`、`W-REL-C-PARAM-04` | `open` | `in-scope` | `EV-EMEVD-FMG-PARAM-03-20260803`、`EV-FMG-MULTILANG-WRITE-20260804`、`EV-PARAM-CORPUS-138-20260804` | EMEVD DSL plan 的 production Bridge/PatchIR transaction 接线已完成；继续完整 EMEDF schema/control-flow、DSL 全局指令级 mutation、UI submit 接线；并行继续 FMG 全语言、全部 ParamType、MSB 实体和回滚 |
...
| `REL-G` | 双协议 AI | `W-AI-CONFORMANCE-03` | `passed` | `in-scope` | `EV-AI-CONFORMANCE-03-20260803`、`EV-AI-CODEX-KERNEL-20260804`、`EV-AI-CODEX-PRODUCTION-20260804`、`EV-AI-CODEX-SUBJECT-SET-20260804` | 错误/取消/超时/限额 10 case 已完成；继续真实工作区多步 typed mutation 矩阵 |
